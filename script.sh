...
--model-file '{"name": "model.pkl", "required": true, "desc": "Classifier saved as pickle", "max_mb": 1}' \
...
--port 30051 \
--movers fly-bert-ruben:experiment-v1 \
--n-tasks 1 \
&& sleep 10
